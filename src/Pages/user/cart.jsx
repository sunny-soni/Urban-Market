...
import {
  ...
  updateProductQty,
  deleteProduct,
} from "../../redux/features/cart/getCartSlice";
import {
  FaTrash,
  FaShoppingBag,
  FaArrowLeft,
    ...
    return (
      <div className="max-w-md mx-auto mt-20 text-center p-10 bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-50 dark:border-slate-800 transition-colors">
        ...
        <p className="text-slate-500 dark:text-slate-400 mb-8">
          Ready to start shopping for the best deals?
        </p>
        <button
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-8 min-h-screen transition-colors duration-300 bg-transparent">
      ...
      >
        ...
        <span className="text-sm font-bold text-slate-500 dark:text-slate-400 group-hover:text-indigo-600 transition-colors uppercase tracking-widest">
          Back to Store
        </span>
      </div>

      <h1 className="text-4xl font-black text-slate-900 dark:text-white mb-8 tracking-tighter">
        My Cart
      </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 space-y-4">
          {cart.map((item) => (
            <div
              key={item.id}
              className="flex flex-col sm:flex-row items-center justify-between bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-5 rounded-3xl shadow-sm hover:shadow-md transition-all gap-4"
            >
              <div className="flex gap-5 items-center w-full sm:w-auto">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-indigo-600 dark:text-indigo-400 font-black text-xl mt-1">
        ...
        <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none sticky top-24 transition-all">
          <h2 className="text-xl font-black text-slate-800 dark:text-slate-100 mb-8 tracking-tight">
            Summary
          </h2>
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="flex justify-between text-slate-500 dark:text-slate-400 font-medium">
              <span>Delivery</span>
              <span className="text-green-500 font-bold uppercase text-[10px] tracking-widest bg-green-50 dark:bg-green-900/20 px-2 py-1 rounded-md">
                Free
              </span>
            </div>
